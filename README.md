...
# 6. Deploy the Function App code (auto-generated script)
./deploy-function-code.ps1

# 7. Create load test (after infrastructure and code deployment)
...
**Note**: The `deploy-function-code.ps1` script is automatically generated by Terraform with the correct resource names. Run this script after `terraform apply` completes to upload your function app code to Azure.
...
```
├── deploy-function-code.ps1          # Generated deployment script with actual resource names
